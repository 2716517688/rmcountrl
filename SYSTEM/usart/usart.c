...
void uart4_init(u32 bound){
  ...
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	//串口1对应引脚复用映射
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource11,GPIO_AF_UART4); //GPIOA11复用为UART4
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource10,GPIO_AF_UART4); //GPIOA10复用为UART4
